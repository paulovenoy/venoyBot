...
describe("Logger Functions", () => {
  ...
  describe("sayLog", () => {
    it("should call console.log with formatted message", () => {
      ...
      assert.strictEqual(args[0], "\x1b[36m[VENOY BOT | TALK]\x1b[0m");
  ...
  describe("inputLog", () => {
    it("should call console.log with input color", () => {
      ...
      assert.strictEqual(consoleLogMock.mock.calls.length, 1);
      const args = consoleLogMock.mock.calls[0].arguments;
      assert.strictEqual(args[0], "\x1b[30m[VENOY BOT | INPUT]\x1b[0m");
  ...
  describe("infoLog", () => {
    it("should call console.log with blue color", () => {
      ...
      assert.strictEqual(consoleLogMock.mock.calls.length, 1);
      const args = consoleLogMock.mock.calls[0].arguments;
      assert.strictEqual(args[0], "\x1b[34m[VENOY BOT | INFO]\x1b[0m");
  ...
  describe("successLog", () => {
    it("should call console.log with green color", () => {
      ...
      assert.strictEqual(consoleLogMock.mock.calls.length, 1);
      const args = consoleLogMock.mock.calls[0].arguments;
      assert.strictEqual(args[0], "\x1b[32m[VENOY BOT | SUCCESS]\x1b[0m");
  ...
  describe("errorLog", () => {
    it("should call console.log with red color", () => {
      ...
      assert.strictEqual(consoleLogMock.mock.calls.length, 1);
      const args = consoleLogMock.mock.calls[0].arguments;
      assert.strictEqual(args[0], "\x1b[31m[VENOY BOT | ERROR]\x1b[0m");
  ...
  describe("warningLog", () => {
    it("should call console.log with yellow color", () => {
      ...
      assert.strictEqual(consoleLogMock.mock.calls.length, 1);
      const args = consoleLogMock.mock.calls[0].arguments;
      assert.strictEqual(args[0], "\x1b[33m[VENOY BOT | WARNING]\x1b[0m");
  ...
  describe("Prefixes", () => {
    it("all logs should have prefix [VENOY BOT]", () => {
      const logFunctions = [
        logger.sayLog,
        logger.inputLog,
        logger.infoLog,
      ...
      for (const fn of logFunctions) {
        ...
        assert.ok(
          prefix.includes("VENOY BOT"),
          "Should include 'VENOY BOT' in prefix"
        );
      }
    });
