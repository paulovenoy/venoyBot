...
# Script para reset da autenticação do Venoy Bot
# Autor: Dev Gui
# Versão: 0.9.0-BETA

echo "🤖 Venoy Bot - Reset da Autenticação"
echo "====================================="
echo ""

if [ ! -d "assets" ]; then
    echo "❌ Erro: Você deve executar este script no diretório raiz do Venoy Bot"
